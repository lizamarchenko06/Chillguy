...
function Header() {
    ...
    const handleSearchSubmit = (event) => {
        ...
        if (searchQuery.toLowerCase() === 'телефон') {
            ...
            navigate('/product/smartphone');
        } else if (searchQuery.toLowerCase()==='часы') {
            navigate('/product/smartwatch');
        } else if (searchQuery.toLowerCase()==='детские часы') {
            navigate('/product/kidswatch');
        } else if (searchQuery.toLowerCase()==='наушники') {
            navigate('/product/headphones');
        } else if (searchQuery.toLowerCase()==='бритва') {
            navigate('/product/electricshaves');
        } else if (searchQuery.toLowerCase()==='холодильник') {
            navigate('/product/fridge');
        } else if (searchQuery.toLowerCase()==='плита') {
            navigate('/product/gasstoves');
        } else if (searchQuery.toLowerCase()==='фен') {
            navigate('/product/hairdryer');
        } else if (searchQuery.toLowerCase()==='ноутбук') {
            navigate('/product/laptop');
        } else if (searchQuery.toLowerCase()==='дрель') {
            navigate('/product/screwdrivers');
        } else {
